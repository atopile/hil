...
async def hil_mcp4728():
    ...
    async with hil_mcp4728.physical_bus.open():
        yield hil_mcp4728


@pytest.mark.runs_on(hostname="lively-sloth")
async def test_write_vref_and_read(hil_mcp4728: HilMCP4728) -> None:
...
@pytest.mark.runs_on(hostname="lively-sloth")
async def test_write_pd_and_wakeup(hil_mcp4728: HilMCP4728) -> None:
    mcp: MCP4728 = hil_mcp4728.mcp
...
@pytest.mark.runs_on(hostname="lively-sloth")
async def test_write_gain_and_read(hil_mcp4728: HilMCP4728) -> None:
    mcp: MCP4728 = hil_mcp4728.mcp
...
@pytest.mark.runs_on(hostname="lively-sloth")
async def test_write_fast_all(hil_mcp4728: HilMCP4728) -> None:
    mcp: MCP4728 = hil_mcp4728.mcp
...
@pytest.mark.runs_on(hostname="lively-sloth")
async def test_write_channel(hil_mcp4728: HilMCP4728) -> None:
    mcp: MCP4728 = hil_mcp4728.mcp
    pd_list = [MCP4728.ChannelPowerDown.NORMAL] * 4
...
@pytest.mark.runs_on(hostname="lively-sloth")
async def test_write_eeprom_all(hil_mcp4728: HilMCP4728) -> None:
    mcp: MCP4728 = hil_mcp4728.mcp
...
@pytest.mark.runs_on(hostname="lively-sloth")
async def test_write_eeprom_single(hil_mcp4728: HilMCP4728) -> None:
    mcp: MCP4728 = hil_mcp4728.mcp
...
@pytest.mark.runs_on(hostname="lively-sloth")
async def test_general_call_reset(hil_mcp4728: HilMCP4728) -> None:
    mcp: MCP4728 = hil_mcp4728.mcp
    pd_list = [MCP4728.ChannelPowerDown.NORMAL] * 4
